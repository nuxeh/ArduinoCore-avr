...
#ifndef MILLIS_TIMER0_PRESCALE
#define MILLIS_TIMER0_PRESCALE 64
#endif
#define MICROSECONDS_PER_TIMER0_OVERFLOW (clockCyclesToMicroseconds(MILLIS_TIMER0_PRESCALE * 256))
